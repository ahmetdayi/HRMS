...
public class KICExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(KICDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new KICStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static KICDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static KICDateTimeConverter dateTimeConverter = new KICStandardDateTimeConverter();

    public KICExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public KICExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new KICMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=KICHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,KICExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=KICHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
