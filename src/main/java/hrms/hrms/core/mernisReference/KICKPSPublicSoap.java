...
public class KICKPSPublicSoap
{
    ...
    public KICKPSPublicSoap(){}

    public KICKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public KICKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        KICExtendedSoapSerializationEnvelope envelope= new KICExtendedSoapSerializationEnvelope(KICExtendedSoapSerializationEnvelope.VER11);
